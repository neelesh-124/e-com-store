          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {user && (
              <Link to={"/cart"} className="relative group">
                ...
                <span className="absolute -top-2 -left-2 bg-emerald-500 text-white rounded-full px-2 py-0.5 text-xs group-hover:bg-emerald-400 transition duration-300 ease-in-out">2</span>
              </Link>
            )}
            {isAdmin && (
              <Link className="bg-emerald-700 hover:bg-emerald-600 text-white px-3 py-1 rounded-md font-medium items-center" to={"/secret-dashboard"}>
